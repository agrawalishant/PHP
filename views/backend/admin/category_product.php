                 ...
                 ?>
                  <tr>
                   ...
                   <td><?php echo $a = word_limiter(strip_tags($dtdisp['answer']), 5);?></td> -->
                     <td>
                        <!-- <a onclick="return confirm('Are you sure you want to Edit this item?');" href="<?php echo base_url();?>view/<?php echo $dtdisp['cat_pro_id'];?>" > <i class="fas fa-eye"></i></a> -->
                        <!-- <a  href="" data-toggle="modal" data-target="#modelview<?php echo $dtdisp['cat_pro_id'];?>" data-id="<?php echo $dtdisp['cat_pro_id'];?>" >  <i class="fas fa-eye"></i></a> -->
                        <a  href="" data-toggle="modal" data-target="#model<?php echo $dtdisp['cat_pro_id'];?>" data-id="<?php echo $dtdisp['cat_pro_id'];?>" >  <i class="fas fa-edit"></i></a>
                        <!-- <a onclick="return confirm('Are you sure you want to Delete this item?');" href="<?php echo base_url();?>deleteteproduct_category/delete/<?php echo $dtdisp['cat_pro_id'];?>" > <i class="fas fa-trash"></i></a> -->
                     </td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="statusMsg"></p>
                <?php echo form_open_multipart(base_url().'add_product_category'); ?>
              ...
              <!-- <div class="form-group">
                ...
                <!-- <div class="form-group">
                   ...
                   <div class="form-group">
                        <label for="inputName">Title</label>
                        <input type="text" class="form-control" id="cat_pro_title" name="cat_pro_title" placeholder="Enter title"/>
                    </div>
                    <!-- <div class="form-group">
...
<!-- Modal -->
<div class="modal fade" id="model<?php echo $iddata=$viewData['cat_pro_id'];?>" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <!-- Modal Header -->
            <div class="modal-header">
            ...
            <div class="modal-body">
                <p class="statusMsg"></p>
                <?php echo form_open_multipart(base_url().'updateproduct_category/update/'.$iddata); ?>
               
                    <div class="form-group">
                        <label for="inputName">Title</label>
                        <input type="text" class="form-control" id="cat_pro_title" name="cat_pro_title" placeholder="cat_pro_title" value="<?php echo $viewData['cat_pro_title'];?>"/>
                    </div>
...
<!-- Modal -->
<div class="modal fade" id="modelview<?php echo $iddata=$viewData['cat_pro_id'];?>" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <!-- Modal Header -->
            <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                   ...
                   -->
                   <p><?php echo $viewData['cat_pro_title'];?></p>
                    </div>
