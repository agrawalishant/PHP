            ...
            <div class="card">
              ...
              <div class="card-body">
               ...
               <tr>
                  ...
                  <?php
                  $sno=0;
                  //MAKE CHANGES WITH PAYMENT IN FUTURE WITH COLUM SEARCH WALL RECEVED FOR
                  //$datadisplay=fetchbyresult('user_chat_detail_history');
                  // $datadisplay=fetchbyresultlimitorder('user_call_detail_history_user',10000,'uch_id','desc');
                  //print_r($datadisplay);
                ...
                $sno++;
                 ?>
                  ...
                  <tr >
                    <td><?php echo $sno;?></td>
                    <td><?php echo $dtdisp['user_first_name'];?></td>
                    <td><?php echo $dtdisp['astro_name'];?></td>
                    <td><?php echo $dtdisp['ucth_totaltime'];?></td>
                    <td><?php echo $dte=date('d-M-Y h:i:sa',strtotime($dtdisp['ucth_chat_starttime']));?></td>
                    <td><?php  $dte2=date('d-M-Y h:i:sa',strtotime($dtdisp['ucth_chat_endtime'])); 
                    if($dtdisp['ucth_chat_endtime'] == "0000-00-00 00:00:00")
                    {
                        echo "CALL FAIL";
                    }
                    else
                    ...
                    ?></td>
                    <td <?php if($dtdisp['ucth_status'] != 1 ){?> style="background : red "<?php }else{ ?>style="background : green " <?php } ?>><?php if($dtdisp['ucth_status']==1){echo "SUCCESSFULLY CHAT";}else{echo "FAILED";};?></td>
                   
                    <!-- 
                    <td><?php echo $dtdisp['product_id'];?></td>
                   ...
                   <td><?php echo $a = word_limiter(strip_tags($dtdisp['answer']), 5);?></td> -->
                     <!-- <td> -->
                        ...
                        <!-- <a  href="" data-toggle="modal" data-target="#modelview<?php echo $dtdisp['ucth_id'];?>" data-id="<?php echo $dtdisp['ucth_id'];?>" >  <i class="fas fa-eye"></i></a> -->
                        <!-- <a  href="" data-toggle="modal" data-target="#model<?php echo $dtdisp['ucth_id'];?>" data-id="<?php echo $dtdisp['ucth_id'];?>" >  <i class="fas fa-edit"></i></a> -->
...
<!-- Modal -->
<div class="modal fade" id="model<?php echo $iddata=$viewData['ucth_id'];?>" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <!-- Modal Header -->
            <div class="modal-header">
...
<!-- Modal -->
<div class="modal fade" id="modelview<?php echo $iddata=$viewData['ucth_id'];?>" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <!-- Modal Header -->
            <div class="modal-header">
