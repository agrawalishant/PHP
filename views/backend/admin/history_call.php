            ...
            <div class="card">
              ...
              <div class="card-body">
               ...
               <tr>
                  ...
                  //$datadisplay=fetchbyresult('wallet_history_admin');
                ...
                $sno++;
                 ?>
                  ...
                  <tr >
                    ...
                    <td><?php echo $dtdisp['uch_totaltime'];?></td>
                    <!-- <td><?php echo $dte=date('d-M-Y h:i:sa',strtotime($dtdisp['uch_call_start_time']));?></td>
                     <td><?php  $dte2=date('d-M-Y h:i:sa',strtotime($dtdisp['uch_call_end_time']));   
                    // if($dtdisp['uch_call_end_time'] == "0000-00-00 00:00:00")
                  //   {
                  //  //     echo "CALL FAIL";
                  //   }
                    // else
                    ...
                    // }
                    ?></td>-->
                    <td <?php if($dtdisp['uch_status'] != 1 ){?> style="background : red "<?php }else{ ?>style="background : green " <?php } ?>><?php if($dtdisp['uch_status']==1){echo "SUCCESSFULLY CONNECTED";}else{echo "FAILED";};?></td>
                   ...
                   <td><?php echo $a = word_limiter(strip_tags($dtdisp['answer']), 5);?></td> -->
                     <!-- <td> -->
                        ...
                        <!-- <a  href="" data-toggle="modal" data-target="#modelview<?php echo $dtdisp['uch_id'];?>" data-id="<?php echo $dtdisp['uch_id'];?>" >  <i class="fas fa-eye"></i></a> -->
                        <!-- <a  href="" data-toggle="modal" data-target="#model<?php echo $dtdisp['uch_id'];?>" data-id="<?php echo $dtdisp['uch_id'];?>" >  <i class="fas fa-edit"></i></a> -->
...
<!-- Modal -->
<div class="modal fade" id="model<?php echo $iddata=$viewData['uch_id'];?>" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <!-- Modal Header -->
            <div class="modal-header">
...
<!-- Modal -->
<div class="modal fade" id="modelview<?php echo $iddata=$viewData['uch_id'];?>" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <!-- Modal Header -->
            <div class="modal-header">
