               ...
               foreach($datadisplay as $datadisp):
                $sno++;
                 ?>
                  ...
                  <tr <?php if($datadisp['user_mobile'] == '' && $datadisp['user_state'] == '' && $datadisp['user_country'] == ''){?>style="background:red" <?php } ?>>>
                    <td><?php echo $sno;?></td>
                    <td><?php echo $datadisp['user_first_name'];?></td>
                    <td><?php echo $datadisp['user_email'];?></td>
                    <td><?php echo $datadisp['user_mobile'];?></td>
                      <td><?php echo $datadisp['user_timestamp'];?></td>
                       <td><?php echo strtoupper($datadisp['registerby']);?></td>
                       <td><span class="badge badge-<?php if($datadisp['delete_status']==1) {echo "danger";}else{echo "success";} ;?>"><?php if($datadisp['delete_status']==1) {echo "Rejected";}else{ echo "Active";} ;?></span></td>
 
                      <td>
                       
                        <a  href="" data-toggle="modal" data-target="#modelview<?php echo $datadisp['user_id'];?>" data-id="<?php echo $datadisp['user_id'];?>" >  <i class="fas fa-eye"></i></a>

                        

                        <!--<a  href="" data-toggle="modal" data-target="#model<?php echo $datadisp['user_id'];?>" data-id="<?php echo $datadisp['user_id'];?>" >  <i class="fas fa-edit"></i></a>-->
                        
                      
                      
                       <a onclick="return confirm('Are you sure you want to Delete this item?');" href="<?php echo base_url();?>deleteuserlist/delete/<?php echo $datadisp['user_id'];?>" > <i class="fas fa-trash"></i></a>
                       <?php if($datadisp['delete_status']==1){?>
                       <a onclick="return confirm('Are you sure you want to Active this item?');" href="<?php echo base_url();?>activeuserlist/active/<?php echo $datadisp['user_id'];?>" > <i class="fas fa-check"></i></a>
                      <?php } else{?>
                       <a onclick="return confirm('Are you sure you want to Inactive this item?');" href="<?php echo base_url();?>inactiveuserlist/inactive/<?php echo $datadisp['user_id'];?>" > <i class="fas fa-power-off"></i></a>
                     <?php } ?>
                     </td>
                    </tr>
                    <?php endforeach;?>
