                ...
                $sno++;
                 ...
                 ?>
                  ...
                  <tr>
                    ...
                    <td><?php echo $sno;?></td>
                     <td><?php echo $datadisp['astro_name'];?></td>
                     <td><?php echo $datadisp['cr_rating'];?></td>
                   ...
                   <!-- <td><?php echo $ad = word_limiter(strip_tags($datadisp['comment_comment']), 2);?></td> -->
                    <td><span class="badge badge-<?php if($datadisp['cr_status']==0) {echo "danger";}else{echo "success";} ;?>"><?php if($datadisp['cr_status']==0) {echo "NOT APP";}else{ echo "APPROVED";} ;?></span></td>
                           <td> 
                        ...
                        <a  href="" data-toggle="modal" data-target="#modelview<?php echo $datadisp['cr_id'];?>" data-id="<?php echo $datadisp['cr_id'];?>" >  <i class="fas fa-eye"></i></a>
                        ...
                        <a onclick="return confirm('Are you sure you want to Delete this item?');" href="<?php echo base_url();?>deletecommentsapprovalastro/delete/<?php echo $datadisp['cr_id'];?>" > <i class="fas fa-trash"></i></a>
                        <?php if($datadisp['cr_status']==0)
                             {?>
                              <a onclick="return confirm('Are you sure you want to Active this item?');" href="<?php echo base_url();?>active_commentsapprovalastro/active/<?php echo $datadisp['cr_id'];?>" style="color:green;" >APPROV</a>
                             <?php } else { ?>
                            
                            <a onclick="return confirm('Are you sure you want to Inactive this item?');" href="<?php echo base_url();?>deactive_commentsapprovalastro/inactive/<?php echo $datadisp['cr_id'];?>" style="color:red" >DIS APPROV</a>
...
<div class="modal fade" id="model<?php echo $iddata=$viewData['cr_id'];?>" role="dialog">
...
<div class="modal fade" id="modelview<?php echo $iddata=$viewData['cr_id'];?>" role="dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                   ...
                   <p><?php echo $viewData['cr_comment'];?></p>
