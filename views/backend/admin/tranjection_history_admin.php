            ...
            <div class="card">
              ...
              <div class="card-body">
               ...
               <tr>
                  ...
                  $datadisplay=fetchbyresultlimitorder('wallet_history_admin',10000,'wlla_id','desc');
                ...
                $sno++;
                 ?>
                  ...
                  <tr >
                    <td><?php echo $sno;?></td>
                    <td><?php echo $dtdisp['wlla_receved_for'];?></td>
                    <td><?php echo $dtdisp['wlla_amount'];?></td>
                    <td><?php echo $dte=date('d-M-Y h:i:sa',strtotime($dtdisp['wlla_timestamp']));?></td>
                   ...
                   <td><?php echo $a = word_limiter(strip_tags($dtdisp['answer']), 5);?></td> -->
                     <!-- <td> -->
                        ...
                        <!-- <a  href="" data-toggle="modal" data-target="#modelview<?php echo $dtdisp['wlla_id '];?>" data-id="<?php echo $dtdisp['wlla_id '];?>" >  <i class="fas fa-eye"></i></a> -->
                        <!-- <a  href="" data-toggle="modal" data-target="#model<?php echo $dtdisp['wlla_id '];?>" data-id="<?php echo $dtdisp['wlla_id '];?>" >  <i class="fas fa-edit"></i></a> -->
...
<!-- Modal -->
<div class="modal fade" id="model<?php echo $iddata=$viewData['wlla_id'];?>" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <!-- Modal Header -->
            <div class="modal-header">
...
<!-- Modal -->
<div class="modal fade" id="modelview<?php echo $iddata=$viewData['wlla_id'];?>" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <!-- Modal Header -->
            <div class="modal-header">
