                ...
                $sno++;
                 ...
                 ?>
                  ...
                  <tr>
                    ...
                    <td><?php echo $sno;?></td>
                   <td><?php echo $a = word_limiter(strip_tags($faq['codename']), 5);?></td>
                   <td><?php echo $faq['codepercent'];?></td>
                   <td><?php echo $faq['startdate'];?></td>
                   <td><?php echo $faq['enddate'];?></td>
                   ...
                   <!-- <td><span class="badge badge-<?php //if($faq['cpn_status']==0) {echo "danger";}elseif($faq['cpn_status']==2) {echo "warning";}else{echo "success";} ;?>"><?php if($faq['cpn_status']==0) {echo "EXPIRED";}elseif($faq['cpn_status']==2) {echo "WAITING";}else{ echo "RUNNING";} ;?></span></td> -->
                     ...
                     <td>
                        <a  href="" data-toggle="modal" data-target="#modelview<?php echo $faq['id'];?>" data-id="<?php echo $faq['id'];?>" >  <i class="fas fa-eye"></i></a>
                        <a  href="" data-toggle="modal" data-target="#model<?php echo $faq['id'];?>" data-id="<?php echo $faq['id'];?>" >  <i class="fas fa-edit"></i></a>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php echo form_open(base_url().'Add-Call-Coupan'); ?>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php echo form_open(base_url().'Update-Coupan/update/'.$iddata); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="cpn_name" name="cpn_name" placeholder="name" value="<?php echo $viewData['codename'];?>"/>
                        <input type="hidden" name="codeid" value="<?php echo $viewData['id'];?>"/>
                    </div>


                      <div class="form-group">

                      <label for="inputName">Amount in %</label>

                      <input type="text" class="form-control" id="cpn_amount" name="cpn_amount" placeholder="name" value="<?php echo $viewData['codepercent'];?>"/>
                      ...
                      <input type="date" class="form-control" id="cpn_startdate" name="cpn_startdate" placeholder="startdate" value="<?php echo $viewData['startdate'];?>"/>
                      ...
                      <input type="date" class="form-control" id="cpn_enddate" name="cpn_enddate" placeholder="cpn_enddate" value="<?php echo $viewData['enddate'];?>"/>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                   ...
                   <p><?php echo $viewData['codename'];?></p>
