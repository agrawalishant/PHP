          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-header">
                ...
                <h3 class="card-title">Enquiry Free Kundali</h3>
                ...
                $sno++;
                 ...
                 ?>
                  ...
                  <tr>
                    ...
                    <td><?php echo $sno;?></td>
                     <td><?php echo $datadisp['fkun_name'];?></td>
                     <td><?php echo $datadisp['fkun_mobile'];?></td>
                     <td><?php echo $datadisp['fkun_gender'];?></td>
                     <td><?php echo $datadisp['fkun_dob'];?></td>
                    <td><?php echo $datadisp['fkun_birth_time'];?></td>
                    <td><?php echo $datadisp['fkun_birth_place'];?></td>
                    <td><span class="badge badge-<?php if($datadisp['status']==0) {echo "danger";}else{echo "success";} ;?>"><?php if($datadisp['status']==0) {echo "WAITING";}else{ echo "CREATED";} ;?></span></td>
...
<div class="modal fade" id="model<?php echo $iddata=$viewData['fkun_id'];?>" role="dialog">
...
<div class="modal fade" id="modelview<?php echo $iddata=$viewData['fkun_id'];?>" role="dialog">
