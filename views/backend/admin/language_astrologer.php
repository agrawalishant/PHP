               ...
               foreach($datadisplay as $dtdisp):
                $sno++;
                 ?>
                  <tr>
                    <td><?php echo $sno;?></td>
                    <td><?php echo $dtdisp['la_title'];?></td>
                   
                   <!-- <td><?php echo $a = word_limiter(strip_tags($dtdisp['question']), 5);?></td>
                   <td><?php echo $a = word_limiter(strip_tags($dtdisp['answer']), 5);?></td> -->
                     <td>
                        
                        <!-- <a  href="" data-toggle="modal" data-target="#modelview<?php echo $dtdisp['la_id'];?>" data-id="<?php echo $dtdisp['la_id'];?>" >  <i class="fas fa-eye"></i></a> -->
                        <a  href="" data-toggle="modal" data-target="#model<?php echo $dtdisp['la_id'];?>" data-id="<?php echo $dtdisp['la_id'];?>" >  <i class="fas fa-edit"></i></a>
...
<!-- Modal -->
<div class="modal fade" id="model<?php echo $iddata=$viewData['la_id'];?>" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <!-- Modal Header -->
            <div class="modal-header">
...
<!-- Modal -->
<div class="modal fade" id="modelview<?php echo $iddata=$viewData['la_id'];?>" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <!-- Modal Header -->
            <div class="modal-header">
