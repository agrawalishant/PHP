    ...
    <div class="hs_slider_heading_wrapper">
        ...
        <div data-aos="fade-up">
            ...
            <div class="hs_slider_logo_cont_wraper">
                ...
                <h1 style="color:#fff;">Talk to Our <span style="color:#f18412;"> Expert </span> Astrologers</h1>
            ...
            <div class="col-md-4 asto-chat-section">
                <div class="hs-astro-contact-info">
                    ...
                    <div class="asto-cont-link" onclick="checklgn();">
                        ...
                        <input type="hidden" name="sesid" id="sesids"
                            value="<?php if(!empty($se_id)) { echo $se_id; }else { echo $se_id = 0 ; } ?>" />
            ...
            <div class="col-md-12 text-center">
                ...
                <div class="bg-white button_margin pic_margin">
                    ...
                    <div class="row home_align">
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6 hs-astro-horscp-section pd-10  wow fadeInDown"
                            data-wow-duration="1s" data-wow-delay="0.1s"
                            style="visibility: visible; animation-duration: 1s; animation-delay: 0.1s; animation-name: fadeInDown;">

                            <a href="<?php echo base_url(); ?>horoscopeyearly_landing/Aries"
                                class="sign_circle bg-aries">
                                <img src="<?php echo base_url();?>assets/frontend/images/header/icon-1.png"
                                    alt="image-missing" class="rotate">
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6 hs-astro-horscp-section pd-10  wow fadeInDown"
                            ...
                            <a href="<?php echo base_url(); ?>horoscopeyearly_landing/Taurus"
                                class="sign_circle bg-aries">

                                <img src="<?php echo base_url();?>assets/frontend/images/header/icon-2.png"
                                    alt="image-missing" class="rotate">
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6 hs-astro-horscp-section pd-10  wow fadeInDown"
                            ...
                            <a href="<?php echo base_url(); ?>horoscopeyearly_landing/Gemini"
                                class="sign_circle bg-aries">

                                <img src="<?php echo base_url();?>assets/frontend/images/header/icon-3.png"
                                    alt="image-missing" class="rotate">
                            ...
                            <div class="main">
                                ...
                                <div class="sign_card text-center signs_bg">
                                    ...
                                    <p>
                                        ...
                                        <span
                                            class="signtext_clr font12"><?php $tofrom=fetchbyresultwhere('horoscopeyearly',array('horoscope_id'=>3));//fetchbyresult();?>
                                            <span class="signtext_clr font12"><?php 
                                    echo date('d-M',strtotime($tofrom['0']['datefirst'])); echo " TO "; echo date('d-M',strtotime($tofrom['0']['datesecond']));
                                    	?></span>
                                    </p>
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6 hs-astro-horscp-section pd-10   wow fadeInDown"
                            ...
                            <a href="<?php echo base_url(); ?>horoscopeyearly_landing/Cancer"
                                class="sign_circle bg-aries">

                                <img src="<?php echo base_url();?>assets/frontend/images/header/icon-4.png"
                                    alt="image-missing" class="rotate">
                            ...
                            <div class="main">
                                ...
                                <div class="sign_card text-center signs_bg">
                                    ...
                                    <p>
                                        ...
                                        <span
                                            class="signtext_clr font12"><?php $tofrom=fetchbyresultwhere('horoscopeyearly',array('horoscope_id'=>4));//fetchbyresult();?>
                                            <span class="signtext_clr font12"><?php 
                                    echo date('d-M',strtotime($tofrom['0']['datefirst'])); echo " TO "; echo date('d-M',strtotime($tofrom['0']['datesecond']));
                                    	?></span>
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6 hs-astro-horscp-section pd-10  wow fadeInDown"
                            ...
                            <a href="<?php echo base_url(); ?>horoscopeyearly_landing/Leo"
                                class="sign_circle bg-aries">

                                <img src="<?php echo base_url();?>assets/frontend/images/header/icon-5.png"
                                    alt="image-missing" class="rotate">
                            ...
                            <div class="main">
                                ...
                                <div class="sign_card text-center signs_bg">
                                    ...
                                    <p>
                                        ...
                                        <span
                                            class="signtext_clr font12"><?php $tofrom=fetchbyresultwhere('horoscopeyearly',array('horoscope_id'=>5));//fetchbyresult();?>
                                            <span class="signtext_clr font12"><?php 
                                    echo date('d-M',strtotime($tofrom['0']['datefirst'])); echo " TO "; echo date('d-M',strtotime($tofrom['0']['datesecond']));
                                    	?></span>
                        ...
                        <div class="row hs-hsp-desktop-view">
                            ...
                            <div class="col-lg-2 col-md-3  hs-astro-horscp-section pd-10  wow fadeInDown"
                                data-wow-duration="1s" data-wow-delay="0.1s"
                                style="visibility: visible; animation-duration: 1s; animation-delay: 0.1s; animation-name: fadeInDown;">

                                <a href="<?php echo base_url(); ?>horoscopeyearly_landing/Virgo"
                                    class="sign_circle bg-aries">

                                    <img src="<?php echo base_url();?>assets/frontend/images/header/icon-6.png"
                                        alt="image-missing" class="rotate">
                                ...
                                <div class="main">
                                    ...
                                    <div class="sign_card text-center signs_bg">
                                        ...
                                        <p>
                                            ...
                                            <span
                                                class="signtext_clr font12"><?php $tofrom=fetchbyresultwhere('horoscopeyearly',array('horoscope_id'=>6));//fetchbyresult();?>
                                                <span class="signtext_clr font12"><?php 
                                    echo date('d-M',strtotime($tofrom['0']['datefirst'])); echo " TO "; echo date('d-M',strtotime($tofrom['0']['datesecond']));
                                    	?></span>
                            ...
                            <div class="col-lg-7 col-md-6">
                                <img src="<?php echo base_url();?>assets/frontend/images/content/service-horoscope-img-01.png"
                                    class="hs-astro-horscop-img">
                            </div>

                            <div class="col-lg-2 col-md-3 hs-astro-horscp-section pd-10 float-right  wow fadeInDown"
                                data-wow-duration="1s" data-wow-delay="0.2s"
                                style="visibility: visible; animation-duration: 1s; animation-delay: 0.2s; animation-name: fadeInDown;">

                                <a href="<?php echo base_url(); ?>horoscopeyearly_landing/Libra"
                                    class="sign_circle bg-aries">

                                    <img src="<?php echo base_url();?>assets/frontend/images/header/icon-7.png"
                                        alt="image-missing" class="rotate">
                                ...
                                <div class="main">
                                    ...
                                    <div class="sign_card text-center signs_bg">
                                        ...
                                        <p>
                                            ...
                                            <span
                                                class="signtext_clr font12"><?php $tofrom=fetchbyresultwhere('horoscopeyearly',array('horoscope_id'=>7));//fetchbyresult();?>
                                                <span class="signtext_clr font12"><?php 
                                    echo date('d-M',strtotime($tofrom['0']['datefirst'])); echo " TO "; echo date('d-M',strtotime($tofrom['0']['datesecond']));
                                    	?></span>
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6 hs-astro-horscp-section pd-10 hsp-mb-view wow fadeInDown"
                            data-wow-duration="1s" data-wow-delay="0.1s"
                            style="visibility: visible; animation-duration: 1s; animation-delay: 0.1s; animation-name: fadeInDown;">
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6 hs-astro-horscp-section pd-10  wow fadeInDown"
                            ...
                            <a href="<?php echo base_url(); ?>horoscopeyearly_landing/Scorpio"
                                class="sign_circle bg-aries">

                                <img src="<?php echo base_url();?>assets/frontend/images/header/icon-8.png"
                                    alt="image-missing" class="rotate">
                            ...
                            <div href="signs_single_post.html" class="main">
                                ...
                                <div class="sign_card text-center signs_bg">
                                    ...
                                    <p>
                                        ...
                                        <span
                                            class="signtext_clr font12"><?php $tofrom=fetchbyresultwhere('horoscopeyearly',array('horoscope_id'=>8));//fetchbyresult();?>
                                            <span class="signtext_clr font12"><?php 
                                    echo date('d-M',strtotime($tofrom['0']['datefirst'])); echo " TO "; echo date('d-M',strtotime($tofrom['0']['datesecond']));
                                    	?></span>
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6 hs-astro-horscp-section pd-10  wow fadeInDown"
                            ...
                            <a href="<?php echo base_url(); ?>horoscopeyearly_landing/Sagittarius"
                                class="sign_circle bg-aries">

                                <img src="<?php echo base_url();?>assets/frontend/images/header/icon-9.png"
                                    alt="image-missing" class="rotate">
                            ...
                            <div class="main">
                                ...
                                <div class="sign_card text-center signs_bg">
                                    ...
                                    <p>
                                        ...
                                        <span
                                            class="signtext_clr font12"><?php $tofrom=fetchbyresultwhere('horoscopeyearly',array('horoscope_id'=>9));//fetchbyresult();?>
                                            <span class="signtext_clr font12"><?php 
                                    echo date('d-M',strtotime($tofrom['0']['datefirst'])); echo " TO "; echo date('d-M',strtotime($tofrom['0']['datesecond']));
                                    	?></span>
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6 hs-astro-horscp-section pd-10  wow fadeInDown"
                            ...
                            <a href="<?php echo base_url(); ?>horoscopeyearly_landing/Capricorn"
                                class="sign_circle bg-aries">

                                <img src="<?php echo base_url();?>assets/frontend/images/header/icon-10.png"
                                    alt="image-missing" class="rotate">
                            ...
                            <div class="main">
                                ...
                                <div class="sign_card text-center signs_bg">
                                    ...
                                    <p>
                                        ...
                                        <span
                                            class="signtext_clr font12"><?php $tofrom=fetchbyresultwhere('horoscopeyearly',array('horoscope_id'=>10));//fetchbyresult();?>
                                            <span class="signtext_clr font12"><?php 
                                    echo date('d-M',strtotime($tofrom['0']['datefirst'])); echo " TO "; echo date('d-M',strtotime($tofrom['0']['datesecond']));
                                    	?></span>
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6 hs-astro-horscp-section pd-10  wow fadeInDown"
                            ...
                            <a href="<?php echo base_url(); ?>horoscopeyearly_landing/Aquarius"
                                class="sign_circle bg-aries">

                                <img src="<?php echo base_url();?>assets/frontend/images/header/icon-11.png"
                                    alt="image-missing" class="rotate">
                            ...
                            <div class="main">
                                ...
                                <div class="sign_card text-center signs_bg">
                                    ...
                                    <p>
                                        ...
                                        <span
                                            class="signtext_clr font12"><?php $tofrom=fetchbyresultwhere('horoscopeyearly',array('horoscope_id'=>11));//fetchbyresult();?>
                                            <span class="signtext_clr font12"><?php 
                                    echo date('d-M',strtotime($tofrom['0']['datefirst'])); echo " TO "; echo date('d-M',strtotime($tofrom['0']['datesecond']));
                                    	?></span>
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6 hs-astro-horscp-section pd-10  wow fadeInDown pic_margin"
                            data-wow-duration="1s" data-wow-delay="0.2s"
                            style="visibility: visible; animation-duration: 1s; animation-delay: 0.2s; animation-name: fadeInDown;">

                            <a href="<?php echo base_url(); ?>horoscopeyearly_landing/Pisces"
                                class="sign_circle bg-aries">

                                <img src="<?php echo base_url();?>assets/frontend/images/header/icon-12.png"
                                    alt="image-missing" class="rotate">
                            ...
                            <div class="main">
                                ...
                                <div class="sign_card text-center signs_bg">
                                    ...
                                    <p>
                                        ...
                                        <span
                                            class="signtext_clr font12"><?php $tofrom=fetchbyresultwhere('horoscopeyearly',array('horoscope_id'=>12));//fetchbyresult();?>
                                            <span class="signtext_clr font12"><?php 
                                    echo date('d-M',strtotime($tofrom['0']['datefirst'])); echo " TO "; echo date('d-M',strtotime($tofrom['0']['datesecond']));
                                    	?></span>
...
?>
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 portfolio-wrapper III_column"
                                data-groups='[ "all","<?php echo $fservice['type'];?>"]'>
                                ...
                                <div class="line-item text-center">
                                    ...
                                    <div class="online-image mb-3">
                                        ...
                                        <img src="<?php echo base_url();?>image/service/<?php echo $fservice['image'];?>?nocache=<?php echo time(); ?>"
                                            onerror="this.src='<?php echo base_url();?>/image/default';"
                                            class="img-fluid" alt="<?php echo $fservice['title'];?>">
                                    ...
                                    <div class="online-content">
                                        ...
                                        <a href="<?php echo base_url();?>services_landing/<?php echo $fservice['url_title'];?>"
                                            class="bookBtn" title="Ask a Question">Book Now</a>
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                ...
                <div class="hs_online_slider_left_cont pd-10">
                    ...
                    <p>Free vedic astrology readings & calculations, daily horoscope, chinese astrology, western
                        astrology based reading and reports.</p>
                            ...
                            <div class="item hs-astro-expert">
                                ...
                                <div class="hs_online_img_wrapper  astro-img-slide">
                                    <div class="ast-img-01">
                                        <img src="<?php echo base_url();?>image/astrologers/<?php echo $fastrologers['astro_image'];?>?nocache=<?php echo time(); ?>"
                                            onerror="this.src='<?php echo base_url();?>/image/default';"
                                            alt="online_img" class="img-responsive" />
            ...
            <div class="col-sm-12">
                ...
                <div class="hs-astro-list">
                    ...
                    <a href="<?php echo base_url('astrotalk/all');?>" class="hs-astro-list-Btn-01">View All Astrologers
                    </a>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12" style="width:100%;">
                ...
                <div class="hs_shop_prodt_main_box">
                    ...
                    <div class="hs_shop_prodt_img_wrapper">
                        ...
                        <img src="<?php echo base_url();?>image/product/<?php echo $fpro['pr_image'];?>?nocache=<?php echo time(); ?>"
                            onerror="this.src='<?php echo base_url();?>/image/default';" alt="shop_product">

                        <?php if($fpro['pr_category']==1) {?>
                        <?php }else{?>
                        <a href="<?php echo base_url('astro_controller/add_to_card/'); ?><?php echo $fpro['pr_id']; ?>">Add
                            to Cart</a>
                        <?php } ?>
                    </div>
                    ...
                    <div class="hs_shop_prodt_img_cont_wrapper">
                        ...
                        <h2><a href="#"><?php echo substr($fpro['pr_title'],0,25);?></a></h2>
                        <?php if($fpro['pr_category']==2) {?>
                        <h3><?php echo $fpro['pr_pricedetail'];?></h3>
                        <?php }else{?>
                        <h3>₹ <?php echo $fpro['pr_finalprice'];?>
                            &nbsp;<del><?php echo $fpro['pr_originalprice'];?></del>&nbsp;
                            <span>(<?php echo $fpro['pr_discount'];?>% off)</span>
                        </h3>
                        <?php } ?>
                        ...
                        <div class="hs-productdetailsBtn">
                            <a href="<?php echo base_url();?>productdetails/<?php echo encoding($fpro['pr_id']);?>">View
                                Details</a>
                        </div>
                    </div>
                                    ...
                                    <div class="hs_testi_cont_main_wrapper">
                                        ...
                                        <div class="hs_testi_client_main_wrapper">
                                            ...
                                            <div class="hs_testi_client_cont_img_sec ">
                                                ...
                                                <img src="<?php echo base_url();?>image/testimonial/<?php echo $ftestimonial['image'];?>?nocache=<?php echo time(); ?> "
                                                    onerror="this.src='<?php echo base_url();?>/image/default';"
                                                    alt="testi_img">
                                        ...
                                        <div class="hs_testi_cont_inner_wrapper">
                                            ...
                                            <div class="hs_testi_quote_cont_wrapper">
                                                ...
                                                <p><?php echo $a = word_limiter(strip_tags( $ftestimonial['description']), 50);?>
                                                </p>
