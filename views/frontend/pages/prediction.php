...
<!-- predictionrow1  -->
<?php $predictionfetch1=fetchbyresultlimitorder('predectionmatter','4','pm_id','asc');
foreach($predictionfetch1 as $pfe1){
?>
              	<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 divider-01">



                    <div class="hs_astros_team_img_main_wrapper ">



                        <div class="hs_astros_img_wrapper">



                           <img src="<?php echo base_url();?>image/prediction/<?php echo $pfe1['pm_image'];?>" alt="team-img" class="img-responsive">
                        ...
                        <div class="hs_astro_img_cont_wrapper">
                            ...
                            <center><h2><a href="#"><?php echo $pfe1['pm_title'];?></a></h2>


                           
                            <p><?php echo $dta = word_limiter(strip_tags($pfe1['pm_description']),10); ?></p>
          	...
          	<div class="col-md-8">
               ...
               <div class="mdss clsCls">
                  ...
                  <div class="sectionhr aboutus qshead">			
                     ...
                     <h3 class="h1tag">For prediction</h3>

                     <h4 class="check wow fadeInUp">Check Your  Prediction</h4>
                 ...
                 <?php echo form_open(base_url().'prediction_submit'); ?>
                   <div class="row">
                     ...
                     <div class="col-md-6">
                       ...
                       <input type="text" name="p_name" placeholder="Name" class="form-control" autocomplete="off" required=""></div>
                   ...
                   <div class="row">
                     ...
                     <div class="col-md-6 col-xs-12">
                       ...
                       <select  class="form-control droupdown select2-hidden-accessible myForm123" tabindex="8" id="state" required="" name="p_country">
...
<input type="text" name="p_mobile" placeholder="Mobile" class="form-control" autocomplete="off" required="">
...
<input value="" type="date" name="p_dob" class="form-control" placeholder="dd/mm/yyyy" required="" id="dp1609396207557"></div>

<div class="col-md-6">

<label>Marital Status</label>

<select class="form-control droupdown select2-hidden-accessible myForm123" name="p_maritalstatus" tabindex="-1" aria-hidden="true" required="">
...
<select class="form-control droupdown select2-hidden-accessible myForm123" name="p_birthhour" tabindex="-1" aria-hidden="true" required="">
...
<select class="form-control droupdown select2-hidden-accessible myForm123" name="p_mirthminite" tabindex="-1" aria-hidden="true" required="">
...
<input type="text" name="p_email" class="form-control" placeholder="Email" autocomplete="off">
...
<select class="form-control droupdown select2-hidden-accessible myForm123" name="p_language" tabindex="-1" aria-hidden="true" required="">
...
<input autocomplete="no-place-found"  placeholder="Place of Birth" type="text" value="" class="form-control" name="p_placeofbirth" id="search" required="">

<input value="" class="hiddenclass" data-val="true" data-val-number="The field Sno must be a number." data-val-required="The Sno field is required." id="Sno" name="p_placeofbirth" type="hidden">
...
<!-- predictionrow1  -->
<?php $predictionfetch1=fetchbyresultlimitorder('predectionmatter','4','pm_id','desc');
foreach($predictionfetch1 as $pfe1){
?>
              	<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 divider-01">
