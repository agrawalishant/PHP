                  ...
                  <div class="row">
                    <div class="col-lg-4 col-md-3 co-sm-12">
                        <div class="form-group">
                            <label>Email</label>
                            <input type="email" name="email" id="email" class="form-control" style="width:212%;">
                             <span ><?php echo form_error('email'); ?></span>
                        </div>
                        <div class="form-group">
                            <label>Password</label>
                            <input type="password" name="password" id="password" class="form-control" style="width:212%;">
...
<script type="text/javascript">
    ...
    function gopaypal()
    {
        ...
        {
            $.ajax({
                url:'<?=base_url()?>Instructor/deletebookings',
                method: 'post',
                data: {},
                dataType: 'json',
    ...
    $(document).on('click','.checks',function(){
        ...
        if(ckdates =='' )
        {
            alert('Date is Mandattry Please select Date of Booking');
            //return false;
        }
        else
        {
