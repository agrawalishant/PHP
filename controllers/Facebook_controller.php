...
class Facebook_controller extends CI_Controller { 
    ...
    public function goofb($id)
    {
        ...
        // if($this->googlee_model->Is_already_register($data['id'],$userData['user_email']))
        if($this->googlee_model->Is_already_register($userData['user_email']))
        {
         //update data
         $user_data = array(
      ...
      // 19/04/2021
        ...
        $this->googlee_model->Update_user_data($user_data,$userData['user_email']);
